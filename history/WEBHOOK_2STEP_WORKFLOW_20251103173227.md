...
- `photos` (list of objects)
  - Chaque photo est un objet avec :
    - `url` (text) - Pour les photos hébergées (type: "url")
    - `data` (text) - Pour les photos en base64 (type: "base64")
    - `type` (text) - "url" ou "base64"
