...
export function AirbnbResultDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={() => {}}>
      <DialogContent className={isFullScreenMode ? "w-screen h-screen max-w-none max-h-none m-0 rounded-none overflow-auto flex flex-col" : "max-w-[95vw] sm:max-w-[900px] max-h-[90vh] overflow-hidden flex flex-col"}>
        <DialogHeader>
