  ...
  return (
    <>
      <Dialog open={open && !modeleDialogOpen && step < 4} onOpenChange={handleClose}>
        <DialogContent
          className={isFullScreenMode ? "w-screen h-screen max-w-none max-h-none m-0 rounded-none" : "sm:max-w-[600px] w-[95vw] max-h-[85vh]"}
          ...
          {step === 1 && (
            <>
              ...
              <div className="flex justify-end pt-4 border-t">
                <Button onClick={handleStep1Next} disabled={!nom.trim() && !airbnbLink.trim()}>
                  Suivant
                </Button>
              </div>
            </>
          ...
          {step === 2 && (
            <>
              <DialogHeader>
                ...
                <div className={isFullScreenMode ? "" : "pl-10"}>
                  <DialogTitle className="text-xl sm:text-2xl">
