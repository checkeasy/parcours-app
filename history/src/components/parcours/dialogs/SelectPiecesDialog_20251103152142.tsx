...
export default function SelectPiecesDialog({
  ...
  const getTaskCountForPiece = (pieceName: string): number => {
    if (typeof selectedModele === "string") {
      // Pour les modèles prédéfinis, retourner un nombre approximatif basé sur les tâches standard
      // En réalité, cela devrait être calculé depuis les données du modèle
      return 3; // Valeur par défaut approximative
    } else {
