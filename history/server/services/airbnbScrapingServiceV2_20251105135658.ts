/**
 * Service de scraping Airbnb V2 - Version simplifiée
 *
 * Utilise les nouveaux endpoints du service Python (port 8000) :
 * - POST /api/extract : Lance l'extraction avec auto_detect_ai
 * - GET /api/status/:id : Retourne le statut ET les données complètes
 *
 * Workflow simplifié :
 * 1. Lance l'extraction
 * 2. Polling sur /api/status jusqu'à "completed"
 * 3. Les données sont déjà dans la réponse de /api/status
 * 4. Télécharge et convertit les images en base64
...
/**
 * Interface pour la réponse de /api/extract
 */
...
/**
 * Interface pour la réponse de /api/status/:id
 */
